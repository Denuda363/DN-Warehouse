  ...
  return (
    <div className="space-y-6 flex flex-col h-[calc(100vh-120px)] w-full">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Laporan Arus Stok</h1>
          <p className="text-slate-500 text-sm">Riwayat seluruh transaksi keluar dan masuk.</p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" className="text-slate-700 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 dark:text-slate-300 w-full sm:w-auto">
      ...
      <Card className="flex-1 flex flex-col overflow-hidden w-full">
        <div className="p-4 border-b dark:border-slate-800 flex flex-col xl:flex-row gap-4 bg-white dark:bg-slate-900">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 w-full xl:w-auto mt-2 xl:mt-0">
            <span className="text-sm text-slate-500 whitespace-nowrap self-start sm:self-center">Tanggal:</span>
