...
export const MasterData: React.FC = () => {
  ...
  const allTabs = [
    { id: "items", label: "Barang / Stok", perm: "MASTER_TAB_ITEMS" },
    ...
    reader.onload = (evt) => {
      ...
      if (activeTab === "items") {
        const newItems = dataArr.map((row: any) => ({
          ...
          sku: row.SKU || "",
          name: row.Nama_Barang || "Unknown",
          purchasePrice: Number(row.Harga_Beli) || 0,
                ...
                filteredItems
                  ...
                  .map((item) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-3 text-right text-indigo-600 font-medium">
                        Rp{" "}
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl w-full max-w-4xl shadow-xl flex flex-col max-h-full">
            <div className="p-6 border-b dark:border-slate-800 flex justify-between items-center shrink-0">
              <h3 className="text-lg font-bold">
                {editItemData?.id ? "Edit" : "Tambah"} Barang
              </h3>
